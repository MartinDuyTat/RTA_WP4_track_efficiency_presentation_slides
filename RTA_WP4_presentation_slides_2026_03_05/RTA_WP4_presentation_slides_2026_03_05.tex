...
\begin{frame}{Tracking efficiency plan}
  \vspace{0.0cm}
  {\Large We are providing analysts the Data/MC long track efficiency ratio for MC reweighting/correction:}
  \vspace{0.2cm}
  \begin{itemize}
...
\begin{frame}{Overview of current progress}
  ...
  \begin{enumerate}
    ...
    \item{Results for tracking efficiencies}
    \begin{itemize}
      \item{2024 blocks 2, 1a, 5--8}
      \item{2024 $pp$ ref run}
      \item{2025 pre-TS}
    \end{itemize}
...
\begin{frame}{Overview of current progress}
  ...
  \begin{enumerate}
    \setlength\itemsep{1.0em}
    \item{Block 1a vs 1b studies}
    \item{\textbf{Results for tracking efficiencies}}
    \begin{itemize}
      \item{2024 blocks 2, 1a, 5--8}
      \item{2024 $pp$ ref run}
      \item{2025 pre-TS}
...
\begin{frame}{Efficiency comparisons}
  ...
  \begin{figure}[htb]
    ...
    \end{subfigure}
  \end{figure}
  {Need to understand why MC underestimates the SciFi efficiency in 2025!}
\end{frame}
...
\begin{frame}{Release of tracking efficiencies}
  ...
  \begin{itemize}
    ...
    \item{I'll also make 1D plots in $p$ and $\eta$}
...
\begin{frame}{Overview of current progress}
  ...
  \begin{enumerate}
    ...
    \begin{itemize}
      ...
      \item{2025 pre-TS}
    \end{itemize}
    \item{\textbf{Guide to TrackCalib2}}
  \end{enumerate}
\end{frame}

\begin{frame}[fragile]{Guide to TrackCalib2}
  \vspace{0.0cm}
  {If you need to produce tracking efficiencies yourselves, for instance if you want to bin in a different variable, you can run TrackCalib2 yourself:}
  \vspace{0.2cm}
  \small
  \begin{lstlisting}
git clone ssh://git@gitlab.cern.ch:7999/lhcb-rta/trackcalib2.git
git checkout mtat/dev/2024
git submodule init
git submodule update
lb-conda trackcalib2
python trackcalib.py prepare -mode MC -year 2024_Block5 -method VeloMuon
python trackcalib.py fit -mode MC -year 2024_Block5 -method VeloMuon -variables "P-ETA"
  \end{lstlisting}
\end{frame}
...
\begin{frame}{Summary and next steps}
  ...
  \begin{enumerate}
    ...
    \begin{itemize}
      ...
      \item{Behaviour consistent between 2024 blocks}
    \end{itemize}
